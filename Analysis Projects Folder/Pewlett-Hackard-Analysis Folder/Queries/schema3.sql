...
-- Indent parameters such as column names and primary keys
-- Enclose parameters within parentheses
-- All details of the table will be inside the parentheses
-- No comma after the last line of code before the closing parenthesis
-- End SQL statement with closing parenthesis and semi colon
...
-- Re-added the PRIMARY KEY (emp_no, dept_no) for dept_employees
...
-- Re-added the PRIMARY KEY (emp_no, from_date) for titles
